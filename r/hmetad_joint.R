...
## fit stan model
m <- cmdstan_model('../stan/hmetad_joint.stan')
...
ggsave('../plots/hmetad_joint/recovery_d_prime.png', width=8, height=5)
...
d.average %>%
    ...
    theme(panel.grid.major=element_line(linewidth=.5, color='grey80'),
          panel.border=element_rect(linewidth=1.5, fill=NA),
          axis.line=element_blank())
ggsave('../plots/hmetad_joint/recovery_c.png', width=8, height=5)
...
d.average %>%
    ...
    theme(panel.grid.major=element_line(linewidth=.5, color='grey80'),
          panel.border=element_rect(linewidth=1.5, fill=NA),
          axis.line=element_blank())
ggsave('../plots/hmetad_joint/recovery_log_M.png', width=8, height=5)
...
ggsave('../plots/hmetad_joint/recovery_corr.png', width=8, height=4)
